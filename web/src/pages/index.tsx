...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      alert(
        "Bolão cria com sucesso, o código foi copiado para a área de tranferência!"
      )
    ...
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <h1 className="mt-14 text-white text-5xl font-bold leading-tight">
          Crie sue próprio bolão da copa e compatilhe entre amigos!
        </h1>
        ...
        <p className="mt-4 text-sm text-gray-300 leading-relaxed">
          Após criar seu bolão, você receberá um código único que poderar usar
      ...
      <Image
        src={appPreviewImg}
        alt="Dois celulares exibindo uma previa da aplicaçao"
        quality={100}
      />
    </div>
  )
